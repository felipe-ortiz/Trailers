...
data class UpcomingMoviesResponse(
    val page: Int? = null,
    @Json(name = "results")
    val upcomingMovieResults: List<UpcomingMovieResult>? = null,
...
fun UpcomingMoviesResponse.toModelMovies() : Array<UpcomingMovie> {
    if (upcomingMovieResults == null) {
        return emptyArray()
    }

    return upcomingMovieResults.map {
        UpcomingMovie(
